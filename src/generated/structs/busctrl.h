...
struct [[gnu::packed]] busctrl
{
     ...
     */
    inline bool get_BUS_PRIORITY_PROC0()
    {
     ...
     */
    inline bool get_BUS_PRIORITY_PROC1()
    {
     ...
     */
    inline bool get_BUS_PRIORITY_DMA_R()
    {
     ...
     */
    inline bool get_BUS_PRIORITY_DMA_W()
    {
     ...
     */
    inline bool get_BUS_PRIORITY_ACK_BUS_PRIORITY_ACK()
    {
     ...
     */
    inline uint32_t get_PERFCTR0_PERFCTR0()
    {
     ...
     */
    inline BUSCTRL_PERFSEL0_PERFSEL0 get_PERFSEL0_PERFSEL0()
    {
     ...
     */
    inline uint32_t get_PERFCTR1_PERFCTR1()
    {
     ...
     */
    inline BUSCTRL_PERFSEL1_PERFSEL1 get_PERFSEL1_PERFSEL1()
    {
     ...
     */
    inline uint32_t get_PERFCTR2_PERFCTR2()
    {
     ...
     */
    inline BUSCTRL_PERFSEL2_PERFSEL2 get_PERFSEL2_PERFSEL2()
    {
     ...
     */
    inline uint32_t get_PERFCTR3_PERFCTR3()
    {
     ...
     */
    inline BUSCTRL_PERFSEL3_PERFSEL3 get_PERFSEL3_PERFSEL3()
    {
