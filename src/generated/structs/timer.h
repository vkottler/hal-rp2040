...
struct [[gnu::packed]] timer
{
  ...
  be disarmed early using the ARMED status register. */
     ...
     */
    inline uint8_t get_ARMED_ARMED()
    {
     ...
     */
    inline void get_DBGPAUSE(bool &DBG0, bool &DBG1)
    {
     ...
     */
    inline void set_DBGPAUSE(bool DBG0, bool DBG1)
    {
        uint32_t curr = DBGPAUSE;
