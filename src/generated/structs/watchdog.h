...
struct [[gnu::packed]] watchdog
{
   ...
   watchdog is triggered.\n The watchdog can be triggered in software. */
     ...
     */
    inline bool get_CTRL_PAUSE_JTAG()
    {
        return CTRL & (1u << 24u);
    }
     ...
     */
    inline bool get_CTRL_PAUSE_DBG0()
    {
        return CTRL & (1u << 25u);
    }
     ...
     */
    inline bool get_CTRL_PAUSE_DBG1()
    {
        return CTRL & (1u << 26u);
    }
    ...
    inline void get_CTRL(uint32_t &TIME, bool &PAUSE_JTAG, bool &PAUSE_DBG0,
                         bool &PAUSE_DBG1, bool &ENABLE, bool &TRIGGER)
    {
        uint32_t curr = CTRL;
     ...
     */
    inline void get_REASON(bool &TIMER, bool &FORCE)
    {
     ...
     */
    inline uint16_t get_TICK_CYCLES()
    {
     ...
     */
    inline uint16_t get_TICK_COUNT()
    {
     ...
     */
    inline void set_TICK(uint16_t CYCLES, bool ENABLE)
    {
        uint32_t curr = TICK;
