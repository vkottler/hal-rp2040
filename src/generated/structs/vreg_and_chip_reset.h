...
struct [[gnu::packed]] vreg_and_chip_reset
{
     ...
     */
    inline void get_VREG(bool &EN, bool &HIZ, uint8_t &VSEL, bool &ROK)
    {
        uint32_t curr = VREG;
     ...
     */
    inline void set_VREG(bool EN, bool HIZ, uint8_t VSEL)
    {
        uint32_t curr = VREG;
     ...
     */
    inline void get_BOD(bool &EN, uint8_t &VSEL)
    {
        uint32_t curr = BOD;
     ...
     */
    inline void set_BOD(bool EN, uint8_t VSEL)
    {
        uint32_t curr = BOD;
     ...
     */
    inline bool get_CHIP_RESET_HAD_POR()
    {
     ...
     */
    inline bool get_CHIP_RESET_HAD_RUN()
    {
     ...
     */
    inline bool get_CHIP_RESET_HAD_PSM_RESTART()
    {
     ...
     */
    inline bool get_CHIP_RESET_PSM_RESTART_FLAG()
    {
    ...
    inline void get_CHIP_RESET(bool &HAD_POR, bool &HAD_RUN,
                               bool &HAD_PSM_RESTART, bool &PSM_RESTART_FLAG)
    {
