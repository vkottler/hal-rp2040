...
struct [[gnu::packed]] adc
{
  ...
  + INT + FRAC / 256 */
    ...
    inline void get_CS(bool &EN, bool &TS_EN, bool &START_ONCE,
                       ...
                       bool &ERR_STICKY, uint8_t &AINSEL, uint8_t &RROBIN)
    {
        uint32_t curr = CS;
     ...
     */
    inline uint16_t get_RESULT_RESULT()
    {
    ...
    inline void set_FCS(bool EN, bool SHIFT, bool ERR, bool DREQ_EN,
                        bool UNDER, bool OVER, uint8_t THRESH)
    {
        uint32_t curr = FCS;
     ...
     */
    inline void get_FIFO(uint16_t &VAL, bool &ERR)
    {
        uint32_t curr = FIFO;
     ...
     */
    inline void get_DIV(uint8_t &FRAC, uint16_t &INT)
    {
        uint32_t curr = DIV;
     ...
     */
    inline void set_DIV(uint8_t FRAC, uint16_t INT)
    {
        uint32_t curr = DIV;
