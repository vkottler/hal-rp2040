...
struct [[gnu::packed]] resets
{
     ...
     */
    inline bool get_RESET_io_bank0()
    {
        return RESET & (1u << 5u);
    }
     ...
     */
    inline bool get_RESET_pads_bank0()
    {
        return RESET & (1u << 8u);
    }
     ...
     */
    inline bool get_RESET_pads_qspi()
    {
        return RESET & (1u << 9u);
    }
    ...
    inline void get_RESET(bool &adc, bool &busctrl, bool &dma, bool &i2c0,
                          ...
                          bool &timer, bool &uart0, bool &uart1, bool &usbctrl)
    {
        uint32_t curr = RESET;
     ...
     */
    inline bool get_WDSEL_io_bank0()
    {
        return WDSEL & (1u << 5u);
    }
     ...
     */
    inline bool get_WDSEL_pads_bank0()
    {
        return WDSEL & (1u << 8u);
    }
     ...
     */
    inline bool get_WDSEL_pads_qspi()
    {
        return WDSEL & (1u << 9u);
    }
     ...
     */
    inline bool get_RESET_DONE_adc()
    {
     ...
     */
    inline bool get_RESET_DONE_busctrl()
    {
     ...
     */
    inline bool get_RESET_DONE_dma()
    {
     ...
     */
    inline bool get_RESET_DONE_i2c0()
    {
     ...
     */
    inline bool get_RESET_DONE_i2c1()
    {
     ...
     */
    inline bool get_RESET_DONE_io_bank0()
    {
     ...
     */
    inline bool get_RESET_DONE_io_qspi()
    {
     ...
     */
    inline bool get_RESET_DONE_jtag()
    {
     ...
     */
    inline bool get_RESET_DONE_pads_bank0()
    {
     ...
     */
    inline bool get_RESET_DONE_pads_qspi()
    {
     ...
     */
    inline bool get_RESET_DONE_pio0()
    {
     ...
     */
    inline bool get_RESET_DONE_pio1()
    {
     ...
     */
    inline bool get_RESET_DONE_pll_sys()
    {
     ...
     */
    inline bool get_RESET_DONE_pll_usb()
    {
     ...
     */
    inline bool get_RESET_DONE_pwm()
    {
     ...
     */
    inline bool get_RESET_DONE_rtc()
    {
     ...
     */
    inline bool get_RESET_DONE_spi0()
    {
     ...
     */
    inline bool get_RESET_DONE_spi1()
    {
     ...
     */
    inline bool get_RESET_DONE_syscfg()
    {
     ...
     */
    inline bool get_RESET_DONE_sysinfo()
    {
     ...
     */
    inline bool get_RESET_DONE_tbman()
    {
     ...
     */
    inline bool get_RESET_DONE_timer()
    {
     ...
     */
    inline bool get_RESET_DONE_uart0()
    {
     ...
     */
    inline bool get_RESET_DONE_uart1()
    {
     ...
     */
    inline bool get_RESET_DONE_usbctrl()
    {
