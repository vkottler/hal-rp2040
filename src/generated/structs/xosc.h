...
sensitive hardware. */
     ...
     */
    inline XOSC_CTRL_FREQ_RANGE get_CTRL_FREQ_RANGE()
    {
     ...
     */
    inline XOSC_CTRL_ENABLE get_CTRL_ENABLE()
    {
     ...
     */
    inline XOSC_STATUS_FREQ_RANGE get_STATUS_FREQ_RANGE()
    {
     ...
     */
    inline uint16_t get_STARTUP_DELAY()
    {
     ...
     */
    inline void get_STARTUP(uint16_t &DELAY, bool &X4)
    {
        uint32_t curr = STARTUP;
     ...
     */
    inline void set_STARTUP(uint16_t DELAY, bool X4)
    {
        uint32_t curr = STARTUP;
