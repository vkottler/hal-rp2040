...
struct [[gnu::packed]] syscfg
{
     ...
     */
    inline bool get_PROC_CONFIG_PROC0_HALTED()
    {
     ...
     */
    inline bool get_PROC_CONFIG_PROC1_HALTED()
    {
     ...
     */
    inline uint8_t get_PROC_CONFIG_PROC0_DAP_INSTID()
    {
     ...
     */
    inline uint8_t get_PROC_CONFIG_PROC1_DAP_INSTID()
    {
     ...
     */
    inline uint32_t get_PROC_IN_SYNC_BYPASS_PROC_IN_SYNC_BYPASS()
    {
     ...
     */
    inline uint8_t get_PROC_IN_SYNC_BYPASS_HI_PROC_IN_SYNC_BYPASS_HI()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC0_SWDO()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC0_SWDI()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC0_SWCLK()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC0_ATTACH()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC1_SWDO()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC1_SWDI()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC1_SWCLK()
    {
     ...
     */
    inline bool get_DBGFORCE_PROC1_ATTACH()
    {
    ...
    inline void get_DBGFORCE(bool &PROC0_SWDO, bool &PROC0_SWDI,
                             ...
                             bool &PROC1_SWCLK, bool &PROC1_ATTACH)
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_SRAM0()
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_SRAM1()
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_SRAM2()
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_SRAM3()
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_SRAM4()
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_SRAM5()
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_USB()
    {
     ...
     */
    inline bool get_MEMPOWERDOWN_ROM()
    {
