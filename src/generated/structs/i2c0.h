...
below are the settings for those parameters */
     ...
     */
    inline I2C0_IC_CON_MASTER_MODE get_IC_CON_MASTER_MODE()
    {
     ...
     */
    inline I2C0_IC_CON_SPEED get_IC_CON_SPEED()
    {
     ...
     */
    inline I2C0_IC_CON_IC_10BITADDR_SLAVE get_IC_CON_IC_10BITADDR_SLAVE()
    {
     ...
     */
    inline I2C0_IC_CON_IC_10BITADDR_MASTER get_IC_CON_IC_10BITADDR_MASTER()
    {
     ...
     */
    inline I2C0_IC_CON_IC_RESTART_EN get_IC_CON_IC_RESTART_EN()
    {
     ...
     */
    inline I2C0_IC_CON_IC_SLAVE_DISABLE get_IC_CON_IC_SLAVE_DISABLE()
    {
     ...
     */
    inline I2C0_IC_CON_STOP_DET_IFADDRESSED get_IC_CON_STOP_DET_IFADDRESSED()
    {
     ...
     */
    inline I2C0_IC_CON_TX_EMPTY_CTRL get_IC_CON_TX_EMPTY_CTRL()
    {
     ...
     */
    inline I2C0_IC_CON_RX_FIFO_FULL_HLD_CTRL get_IC_CON_RX_FIFO_FULL_HLD_CTRL()
    {
     ...
     */
    inline bool get_IC_CON_STOP_DET_IF_MASTER_ACTIVE()
    {
     ...
     */
    inline uint16_t get_IC_TAR_IC_TAR()
    {
     ...
     */
    inline I2C0_IC_TAR_GC_OR_START get_IC_TAR_GC_OR_START()
    {
     ...
     */
    inline I2C0_IC_TAR_SPECIAL get_IC_TAR_SPECIAL()
    {
     ...
     */
    inline uint16_t get_IC_SAR_IC_SAR()
    {
     ...
     */
    inline uint8_t get_IC_DATA_CMD_DAT()
    {
     ...
     */
    inline I2C0_IC_DATA_CMD_CMD get_IC_DATA_CMD_CMD()
    {
     ...
     */
    inline I2C0_IC_DATA_CMD_STOP get_IC_DATA_CMD_STOP()
    {
     ...
     */
    inline I2C0_IC_DATA_CMD_RESTART get_IC_DATA_CMD_RESTART()
    {
     ...
     */
    inline I2C0_IC_DATA_CMD_FIRST_DATA_BYTE get_IC_DATA_CMD_FIRST_DATA_BYTE()
    {
    ...
    inline void get_IC_DATA_CMD(
        ...
        I2C0_IC_DATA_CMD_FIRST_DATA_BYTE &FIRST_DATA_BYTE)
    {
        uint32_t curr = IC_DATA_CMD;
     ...
     */
    inline uint16_t get_IC_SS_SCL_HCNT_IC_SS_SCL_HCNT()
    {
     ...
     */
    inline uint16_t get_IC_SS_SCL_LCNT_IC_SS_SCL_LCNT()
    {
     ...
     */
    inline uint16_t get_IC_FS_SCL_HCNT_IC_FS_SCL_HCNT()
    {
     ...
     */
    inline uint16_t get_IC_FS_SCL_LCNT_IC_FS_SCL_LCNT()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_RX_UNDER get_IC_INTR_STAT_R_RX_UNDER()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_RX_OVER get_IC_INTR_STAT_R_RX_OVER()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_RX_FULL get_IC_INTR_STAT_R_RX_FULL()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_TX_OVER get_IC_INTR_STAT_R_TX_OVER()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_TX_EMPTY get_IC_INTR_STAT_R_TX_EMPTY()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_RD_REQ get_IC_INTR_STAT_R_RD_REQ()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_TX_ABRT get_IC_INTR_STAT_R_TX_ABRT()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_RX_DONE get_IC_INTR_STAT_R_RX_DONE()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_ACTIVITY get_IC_INTR_STAT_R_ACTIVITY()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_STOP_DET get_IC_INTR_STAT_R_STOP_DET()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_START_DET get_IC_INTR_STAT_R_START_DET()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_GEN_CALL get_IC_INTR_STAT_R_GEN_CALL()
    {
     ...
     */
    inline I2C0_IC_INTR_STAT_R_RESTART_DET get_IC_INTR_STAT_R_RESTART_DET()
    {
    ...
    inline void get_IC_INTR_STAT(
        ...
        I2C0_IC_INTR_STAT_R_RESTART_DET &R_RESTART_DET)
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_RX_UNDER get_IC_INTR_MASK_M_RX_UNDER()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_RX_OVER get_IC_INTR_MASK_M_RX_OVER()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_RX_FULL get_IC_INTR_MASK_M_RX_FULL()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_TX_OVER get_IC_INTR_MASK_M_TX_OVER()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_TX_EMPTY get_IC_INTR_MASK_M_TX_EMPTY()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_RD_REQ get_IC_INTR_MASK_M_RD_REQ()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_TX_ABRT get_IC_INTR_MASK_M_TX_ABRT()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_RX_DONE get_IC_INTR_MASK_M_RX_DONE()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_ACTIVITY get_IC_INTR_MASK_M_ACTIVITY()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_STOP_DET get_IC_INTR_MASK_M_STOP_DET()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_START_DET get_IC_INTR_MASK_M_START_DET()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_GEN_CALL get_IC_INTR_MASK_M_GEN_CALL()
    {
     ...
     */
    inline I2C0_IC_INTR_MASK_M_RESTART_DET get_IC_INTR_MASK_M_RESTART_DET()
    {
    ...
    inline void get_IC_INTR_MASK(
        ...
        I2C0_IC_INTR_MASK_M_RESTART_DET &M_RESTART_DET)
    {
     ...
     */
    inline void set_IC_INTR_MASK(I2C0_IC_INTR_MASK_M_RX_UNDER M_RX_UNDER,
                                 I2C0_IC_INTR_MASK_M_RX_OVER M_RX_OVER,
                                 I2C0_IC_INTR_MASK_M_RX_FULL M_RX_FULL,
                                 I2C0_IC_INTR_MASK_M_TX_OVER M_TX_OVER,
                                 I2C0_IC_INTR_MASK_M_TX_EMPTY M_TX_EMPTY,
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_RX_UNDER get_IC_RAW_INTR_STAT_RX_UNDER()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_RX_OVER get_IC_RAW_INTR_STAT_RX_OVER()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_RX_FULL get_IC_RAW_INTR_STAT_RX_FULL()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_TX_OVER get_IC_RAW_INTR_STAT_TX_OVER()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_TX_EMPTY get_IC_RAW_INTR_STAT_TX_EMPTY()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_RD_REQ get_IC_RAW_INTR_STAT_RD_REQ()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_TX_ABRT get_IC_RAW_INTR_STAT_TX_ABRT()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_RX_DONE get_IC_RAW_INTR_STAT_RX_DONE()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_ACTIVITY get_IC_RAW_INTR_STAT_ACTIVITY()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_STOP_DET get_IC_RAW_INTR_STAT_STOP_DET()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_START_DET get_IC_RAW_INTR_STAT_START_DET()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_GEN_CALL get_IC_RAW_INTR_STAT_GEN_CALL()
    {
     ...
     */
    inline I2C0_IC_RAW_INTR_STAT_RESTART_DET get_IC_RAW_INTR_STAT_RESTART_DET()
    {
    ...
    inline void get_IC_RAW_INTR_STAT(
        ...
        I2C0_IC_RAW_INTR_STAT_RESTART_DET &RESTART_DET)
    {
     ...
     */
    inline uint8_t get_IC_RX_TL_RX_TL()
    {
     ...
     */
    inline uint8_t get_IC_TX_TL_TX_TL()
    {
     ...
     */
    inline bool get_IC_CLR_INTR_CLR_INTR()
    {
     ...
     */
    inline bool get_IC_CLR_RX_UNDER_CLR_RX_UNDER()
    {
     ...
     */
    inline bool get_IC_CLR_RX_OVER_CLR_RX_OVER()
    {
     ...
     */
    inline bool get_IC_CLR_TX_OVER_CLR_TX_OVER()
    {
     ...
     */
    inline bool get_IC_CLR_RD_REQ_CLR_RD_REQ()
    {
     ...
     */
    inline bool get_IC_CLR_TX_ABRT_CLR_TX_ABRT()
    {
     ...
     */
    inline bool get_IC_CLR_RX_DONE_CLR_RX_DONE()
    {
     ...
     */
    inline bool get_IC_CLR_ACTIVITY_CLR_ACTIVITY()
    {
     ...
     */
    inline bool get_IC_CLR_STOP_DET_CLR_STOP_DET()
    {
     ...
     */
    inline bool get_IC_CLR_START_DET_CLR_START_DET()
    {
     ...
     */
    inline bool get_IC_CLR_GEN_CALL_CLR_GEN_CALL()
    {
     ...
     */
    inline I2C0_IC_ENABLE_ENABLE get_IC_ENABLE_ENABLE()
    {
     ...
     */
    inline I2C0_IC_ENABLE_ABORT get_IC_ENABLE_ABORT()
    {
     ...
     */
    inline I2C0_IC_ENABLE_TX_CMD_BLOCK get_IC_ENABLE_TX_CMD_BLOCK()
    {
     ...
     */
    inline void get_IC_ENABLE(I2C0_IC_ENABLE_ENABLE &ENABLE,
                              I2C0_IC_ENABLE_ABORT &ABORT,
                              I2C0_IC_ENABLE_TX_CMD_BLOCK &TX_CMD_BLOCK)
    {
     ...
     */
    inline void set_IC_ENABLE(I2C0_IC_ENABLE_ENABLE ENABLE,
                              I2C0_IC_ENABLE_ABORT ABORT,
                              I2C0_IC_ENABLE_TX_CMD_BLOCK TX_CMD_BLOCK)
    {
        uint32_t curr = IC_ENABLE;
     ...
     */
    inline I2C0_IC_STATUS_ACTIVITY get_IC_STATUS_ACTIVITY()
    {
     ...
     */
    inline I2C0_IC_STATUS_TFNF get_IC_STATUS_TFNF()
    {
     ...
     */
    inline I2C0_IC_STATUS_TFE get_IC_STATUS_TFE()
    {
     ...
     */
    inline I2C0_IC_STATUS_RFNE get_IC_STATUS_RFNE()
    {
     ...
     */
    inline I2C0_IC_STATUS_RFF get_IC_STATUS_RFF()
    {
     ...
     */
    inline I2C0_IC_STATUS_MST_ACTIVITY get_IC_STATUS_MST_ACTIVITY()
    {
     ...
     */
    inline I2C0_IC_STATUS_SLV_ACTIVITY get_IC_STATUS_SLV_ACTIVITY()
    {
     ...
     */
    inline void get_IC_STATUS(I2C0_IC_STATUS_ACTIVITY &ACTIVITY,
                              I2C0_IC_STATUS_TFNF &TFNF,
                              I2C0_IC_STATUS_TFE &TFE,
                              I2C0_IC_STATUS_RFNE &RFNE,
                              I2C0_IC_STATUS_RFF &RFF,
                              I2C0_IC_STATUS_MST_ACTIVITY &MST_ACTIVITY,
                              I2C0_IC_STATUS_SLV_ACTIVITY &SLV_ACTIVITY)
    {
     ...
     */
    inline uint8_t get_IC_TXFLR_TXFLR()
    {
     ...
     */
    inline uint8_t get_IC_RXFLR_RXFLR()
    {
     ...
     */
    inline uint16_t get_IC_SDA_HOLD_IC_SDA_TX_HOLD()
    {
     ...
     */
    inline uint8_t get_IC_SDA_HOLD_IC_SDA_RX_HOLD()
    {
     ...
     */
    inline I2C0_IC_TX_ABRT_SOURCE_ARB_LOST get_IC_TX_ABRT_SOURCE_ARB_LOST()
    {
     ...
     */
    inline uint16_t get_IC_TX_ABRT_SOURCE_TX_FLUSH_CNT()
    {
     ...
     */
    inline I2C0_IC_SLV_DATA_NACK_ONLY_NACK get_IC_SLV_DATA_NACK_ONLY_NACK()
    {
     ...
     */
    inline I2C0_IC_DMA_CR_RDMAE get_IC_DMA_CR_RDMAE()
    {
     ...
     */
    inline I2C0_IC_DMA_CR_TDMAE get_IC_DMA_CR_TDMAE()
    {
     ...
     */
    inline uint8_t get_IC_DMA_TDLR_DMATDL()
    {
     ...
     */
    inline uint8_t get_IC_DMA_RDLR_DMARDL()
    {
     ...
     */
    inline uint8_t get_IC_SDA_SETUP_SDA_SETUP()
    {
     ...
     */
    inline I2C0_IC_ENABLE_STATUS_IC_EN get_IC_ENABLE_STATUS_IC_EN()
    {
    ...
    inline void get_IC_ENABLE_STATUS(
        ...
        I2C0_IC_ENABLE_STATUS_SLV_RX_DATA_LOST &SLV_RX_DATA_LOST)
    {
     ...
     */
    inline uint8_t get_IC_FS_SPKLEN_IC_FS_SPKLEN()
    {
     ...
     */
    inline bool get_IC_CLR_RESTART_DET_CLR_RESTART_DET()
    {
     ...
     */
    inline uint8_t get_IC_COMP_PARAM_1_APB_DATA_WIDTH()
    {
     ...
     */
    inline uint8_t get_IC_COMP_PARAM_1_MAX_SPEED_MODE()
    {
     ...
     */
    inline bool get_IC_COMP_PARAM_1_HC_COUNT_VALUES()
    {
     ...
     */
    inline bool get_IC_COMP_PARAM_1_INTR_IO()
    {
     ...
     */
    inline bool get_IC_COMP_PARAM_1_HAS_DMA()
    {
     ...
     */
    inline bool get_IC_COMP_PARAM_1_ADD_ENCODED_PARAMS()
    {
     ...
     */
    inline uint8_t get_IC_COMP_PARAM_1_RX_BUFFER_DEPTH()
    {
     ...
     */
    inline uint8_t get_IC_COMP_PARAM_1_TX_BUFFER_DEPTH()
    {
     ...
     */
    inline uint32_t get_IC_COMP_VERSION_IC_COMP_VERSION()
    {
     ...
     */
    inline uint32_t get_IC_COMP_TYPE_IC_COMP_TYPE()
    {
