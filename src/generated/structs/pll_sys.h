...
struct [[gnu::packed]] pll_sys
{
     ...
     */
    inline void get_CS(uint8_t &REFDIV, bool &BYPASS, bool &LOCK)
    {
        uint32_t curr = CS;
     ...
     */
    inline void set_CS(uint8_t REFDIV, bool BYPASS)
    {
        uint32_t curr = CS;
     ...
     */
    inline void get_PWR(bool &PD, bool &DSMPD, bool &POSTDIVPD, bool &VCOPD)
    {
        uint32_t curr = PWR;
     ...
     */
    inline void set_PWR(bool PD, bool DSMPD, bool POSTDIVPD, bool VCOPD)
    {
        uint32_t curr = PWR;
     ...
     */
    inline uint16_t get_FBDIV_INT_FBDIV_INT()
    {
     ...
     */
    inline uint8_t get_PRIM_POSTDIV2()
    {
     ...
     */
    inline uint8_t get_PRIM_POSTDIV1()
    {
     ...
     */
    inline void get_PRIM(uint8_t &POSTDIV2, uint8_t &POSTDIV1)
    {
        uint32_t curr = PRIM;
     ...
     */
    inline void set_PRIM(uint8_t POSTDIV2, uint8_t POSTDIV1)
    {
        uint32_t curr = PRIM;
