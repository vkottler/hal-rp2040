...
struct [[gnu::packed]] xip_ctrl
{
     ...
     */
    inline bool get_CTRL_ERR_BADWRITE()
    {
        return CTRL & (1u << 1u);
    }
     ...
     */
    inline bool get_CTRL_POWER_DOWN()
    {
        return CTRL & (1u << 3u);
    }
     ...
     */
    inline void get_CTRL(bool &EN, bool &ERR_BADWRITE, bool &POWER_DOWN)
    {
        uint32_t curr = CTRL;
     ...
     */
    inline void set_CTRL(bool EN, bool ERR_BADWRITE, bool POWER_DOWN)
    {
        uint32_t curr = CTRL;
     ...
     */
    inline bool get_STAT_FLUSH_READY()
    {
        return STAT & (1u << 0u);
    }
     ...
     */
    inline bool get_STAT_FIFO_EMPTY()
    {
        return STAT & (1u << 1u);
    }
     ...
     */
    inline bool get_STAT_FIFO_FULL()
    {
        return STAT & (1u << 2u);
    }
     ...
     */
    inline void get_STAT(bool &FLUSH_READY, bool &FIFO_EMPTY, bool &FIFO_FULL)
    {
        uint32_t curr = STAT;
     ...
     */
    inline uint32_t get_STREAM_ADDR_STREAM_ADDR()
    {
     ...
     */
    inline uint32_t get_STREAM_CTR_STREAM_CTR()
    {
