...
but are also exposed here. */
   ...
   instruction immediately (including jumps) and then resume execution. */
     ...
     */
    PIO0_SM0_EXECCTRL_STATUS_SEL get_SM0_EXECCTRL_STATUS_SEL()
    {
     ...
     */
    PIO0_SM1_EXECCTRL_STATUS_SEL get_SM1_EXECCTRL_STATUS_SEL()
    {
     ...
     */
    PIO0_SM2_EXECCTRL_STATUS_SEL get_SM2_EXECCTRL_STATUS_SEL()
    {
     ...
     */
    PIO0_SM3_EXECCTRL_STATUS_SEL get_SM3_EXECCTRL_STATUS_SEL()
    {
