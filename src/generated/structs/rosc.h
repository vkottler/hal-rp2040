...
struct [[gnu::packed]] rosc
{
 ...
 sensitive hardware. */
     ...
     */
    inline ROSC_CTRL_FREQ_RANGE get_CTRL_FREQ_RANGE()
    {
     ...
     */
    inline ROSC_CTRL_ENABLE get_CTRL_ENABLE()
    {
     ...
     */
    inline ROSC_FREQA_PASSWD get_FREQA_PASSWD()
    {
    ...
    inline void get_FREQA(uint8_t &DS0, uint8_t &DS1, uint8_t &DS2,
                          uint8_t &DS3, ROSC_FREQA_PASSWD &PASSWD)
    {
        uint32_t curr = FREQA;
     ...
     */
    inline ROSC_FREQB_PASSWD get_FREQB_PASSWD()
    {
    ...
    inline void get_FREQB(uint8_t &DS4, uint8_t &DS5, uint8_t &DS6,
                          uint8_t &DS7, ROSC_FREQB_PASSWD &PASSWD)
    {
        uint32_t curr = FREQB;
     ...
     * Get DIV's DIV field.
     */
    inline ROSC_DIV_DIV get_DIV_DIV()
    {
     ...
     */
    inline uint8_t get_PHASE_SHIFT()
    {
     ...
     */
    inline uint8_t get_PHASE_PASSWD()
    {
     ...
     */
    inline bool get_STATUS_ENABLED()
    {
     ...
     */
    inline bool get_STATUS_DIV_RUNNING()
    {
     ...
     */
    inline bool get_STATUS_BADWRITE()
    {
     ...
     */
    inline bool get_RANDOMBIT_RANDOMBIT()
    {
     ...
     */
    inline uint8_t get_COUNT_COUNT()
    {
