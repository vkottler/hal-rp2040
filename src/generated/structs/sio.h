...
wins.\n The value returned on success is 0x1 << lock number. */
     ...
     */
    uint8_t get_GPIO_HI_IN_GPIO_HI_IN()
    {
     ...
     */
    uint32_t get_GPIO_OUT_GPIO_OUT()
    {
     ...
     */
    uint8_t get_GPIO_HI_OUT_GPIO_HI_OUT()
    {
     ...
     */
    uint8_t get_GPIO_HI_OE_GPIO_HI_OE()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE0_SHIFT()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE0_MASK_LSB()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE0_MASK_MSB()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_SIGNED()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_CROSS_INPUT()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_CROSS_RESULT()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_ADD_RAW()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE0_FORCE_MSB()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_BLEND()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_OVERF0()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_OVERF1()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE0_OVERF()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE1_SHIFT()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE1_MASK_LSB()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE1_MASK_MSB()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE1_SIGNED()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE1_CROSS_INPUT()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE1_CROSS_RESULT()
    {
     ...
     */
    bool get_INTERP0_CTRL_LANE1_ADD_RAW()
    {
     ...
     */
    uint8_t get_INTERP0_CTRL_LANE1_FORCE_MSB()
    {
     ...
     */
    uint32_t get_INTERP0_ACCUM0_ADD_INTERP0_ACCUM0_ADD()
    {
     ...
     */
    uint32_t get_INTERP0_ACCUM1_ADD_INTERP0_ACCUM1_ADD()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE0_SHIFT()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE0_MASK_LSB()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE0_MASK_MSB()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_SIGNED()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_CROSS_INPUT()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_CROSS_RESULT()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_ADD_RAW()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE0_FORCE_MSB()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_CLAMP()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_OVERF0()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_OVERF1()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE0_OVERF()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE1_SHIFT()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE1_MASK_LSB()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE1_MASK_MSB()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE1_SIGNED()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE1_CROSS_INPUT()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE1_CROSS_RESULT()
    {
     ...
     */
    bool get_INTERP1_CTRL_LANE1_ADD_RAW()
    {
     ...
     */
    uint8_t get_INTERP1_CTRL_LANE1_FORCE_MSB()
    {
     ...
     */
    uint32_t get_INTERP1_ACCUM0_ADD_INTERP1_ACCUM0_ADD()
    {
     ...
     */
    uint32_t get_INTERP1_ACCUM1_ADD_INTERP1_ACCUM1_ADD()
    {
