...
{
    7BITS /*!< Slave 7Bit addressing */,
    10BITS = 1 /*!< Slave 10Bit addressing */
};
...
inline const char *to_string(I2C0_IC_CON_IC_10BITADDR_SLAVE instance)
{
    ...
    switch (instance)
    {
    case I2C0_IC_CON_IC_10BITADDR_SLAVE::7BITS:
        result = "7BITS";
        break;
    case I2C0_IC_CON_IC_10BITADDR_SLAVE::10BITS:
        result = "10BITS";
        break;
    }
                        ...
                        I2C0_IC_CON_IC_10BITADDR_SLAVE &output)
{
    ...
    {
        output = I2C0_IC_CON_IC_10BITADDR_SLAVE::7BITS;
    }
    else if ((result = !strncmp(data, "10BITS", 6)))
    {
        output = I2C0_IC_CON_IC_10BITADDR_SLAVE::10BITS;
    }
