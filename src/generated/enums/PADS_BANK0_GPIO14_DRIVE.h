...
static constexpr uint16_t PADS_BANK0_GPIO14_DRIVE_id = 339;
...
inline const char *to_string(PADS_BANK0_GPIO14_DRIVE instance)
{
    ...
    switch (instance)
    {
    case PADS_BANK0_GPIO14_DRIVE::2mA:
        result = "2mA";
        break;
    case PADS_BANK0_GPIO14_DRIVE::4mA:
        result = "4mA";
        break;
    case PADS_BANK0_GPIO14_DRIVE::8mA:
        result = "8mA";
        break;
    case PADS_BANK0_GPIO14_DRIVE::12mA:
        result = "12mA";
        break;
    }
...
inline bool from_string(const char *data, PADS_BANK0_GPIO14_DRIVE &output)
{
    ...
    {
        output = PADS_BANK0_GPIO14_DRIVE::2mA;
    }
    else if ((result = !strncmp(data, "4mA", 3)))
    {
        output = PADS_BANK0_GPIO14_DRIVE::4mA;
    }
    else if ((result = !strncmp(data, "8mA", 3)))
    {
        output = PADS_BANK0_GPIO14_DRIVE::8mA;
    }
    else if ((result = !strncmp(data, "12mA", 4)))
    {
        output = PADS_BANK0_GPIO14_DRIVE::12mA;
    }
