...
static constexpr uint16_t DMA_CH5_CTRL_TRIG_DATA_SIZE_id = 178;
...
inline const char *to_string(DMA_CH5_CTRL_TRIG_DATA_SIZE instance)
{
    ...
    switch (instance)
    {
    case DMA_CH5_CTRL_TRIG_DATA_SIZE::SIZE_BYTE:
        result = "SIZE_BYTE";
        break;
    case DMA_CH5_CTRL_TRIG_DATA_SIZE::SIZE_HALFWORD:
        result = "SIZE_HALFWORD";
        break;
    case DMA_CH5_CTRL_TRIG_DATA_SIZE::SIZE_WORD:
        result = "SIZE_WORD";
        break;
    }
...
inline bool from_string(const char *data, DMA_CH5_CTRL_TRIG_DATA_SIZE &output)
{
    ...
    {
        output = DMA_CH5_CTRL_TRIG_DATA_SIZE::SIZE_BYTE;
    }
    else if ((result = !strncmp(data, "SIZE_HALFWORD", 13)))
    {
        output = DMA_CH5_CTRL_TRIG_DATA_SIZE::SIZE_HALFWORD;
    }
    else if ((result = !strncmp(data, "SIZE_WORD", 9)))
    {
        output = DMA_CH5_CTRL_TRIG_DATA_SIZE::SIZE_WORD;
    }
