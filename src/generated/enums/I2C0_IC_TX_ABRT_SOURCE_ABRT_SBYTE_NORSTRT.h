...
static constexpr uint16_t I2C0_IC_TX_ABRT_SOURCE_ABRT_SBYTE_NORSTRT_id = 129;
    ...
    I2C0_IC_TX_ABRT_SOURCE_ABRT_SBYTE_NORSTRT instance)
{
    ...
    case I2C0_IC_TX_ABRT_SOURCE_ABRT_SBYTE_NORSTRT::ABRT_SBYTE_NORSTRT_VOID:
        ...
        break;
    case I2C0_IC_TX_ABRT_SOURCE_ABRT_SBYTE_NORSTRT::
        ABRT_SBYTE_NORSTRT_GENERATED:
                        ...
                        I2C0_IC_TX_ABRT_SOURCE_ABRT_SBYTE_NORSTRT &output)
{
    ...
    {
        output =
            I2C0_IC_TX_ABRT_SOURCE_ABRT_SBYTE_NORSTRT::ABRT_SBYTE_NORSTRT_VOID;
    }
    else if ((result = !strncmp(data, "ABRT_SBYTE_NORSTRT_GENERATED", 28)))
    {
        output = I2C0_IC_TX_ABRT_SOURCE_ABRT_SBYTE_NORSTRT::
            ABRT_SBYTE_NORSTRT_GENERATED;
    }
