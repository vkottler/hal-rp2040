...
static constexpr uint16_t PADS_QSPI_GPIO_QSPI_SD0_DRIVE_id = 359;
...
inline const char *to_string(PADS_QSPI_GPIO_QSPI_SD0_DRIVE instance)
{
    ...
    switch (instance)
    {
    case PADS_QSPI_GPIO_QSPI_SD0_DRIVE::2mA:
        result = "2mA";
        break;
    case PADS_QSPI_GPIO_QSPI_SD0_DRIVE::4mA:
        result = "4mA";
        break;
    case PADS_QSPI_GPIO_QSPI_SD0_DRIVE::8mA:
        result = "8mA";
        break;
    case PADS_QSPI_GPIO_QSPI_SD0_DRIVE::12mA:
        result = "12mA";
        break;
    }
                        ...
                        PADS_QSPI_GPIO_QSPI_SD0_DRIVE &output)
{
    ...
    {
        output = PADS_QSPI_GPIO_QSPI_SD0_DRIVE::2mA;
    }
    else if ((result = !strncmp(data, "4mA", 3)))
    {
        output = PADS_QSPI_GPIO_QSPI_SD0_DRIVE::4mA;
    }
    else if ((result = !strncmp(data, "8mA", 3)))
    {
        output = PADS_QSPI_GPIO_QSPI_SD0_DRIVE::8mA;
    }
    else if ((result = !strncmp(data, "12mA", 4)))
    {
        output = PADS_QSPI_GPIO_QSPI_SD0_DRIVE::12mA;
    }
