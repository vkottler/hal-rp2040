...
static constexpr uint16_t PADS_QSPI_VOLTAGE_SELECT_VOLTAGE_SELECT_id = 6;
...
inline const char *to_string(PADS_QSPI_VOLTAGE_SELECT_VOLTAGE_SELECT instance)
{
    ...
    switch (instance)
    {
    case PADS_QSPI_VOLTAGE_SELECT_VOLTAGE_SELECT::3v3:
        result = "3v3";
        break;
    case PADS_QSPI_VOLTAGE_SELECT_VOLTAGE_SELECT::1v8:
        result = "1v8";
        break;
    }
...
inline bool from_string(const char *data, PADS_QSPI_VOLTAGE_SELECT_VOLTAGE_SELECT &output)
{
    ...
    {
        output = PADS_QSPI_VOLTAGE_SELECT_VOLTAGE_SELECT::3v3;
    }
    else if ((result = !strncmp(data, "1v8", 3)))
    {
        output = PADS_QSPI_VOLTAGE_SELECT_VOLTAGE_SELECT::1v8;
    }
