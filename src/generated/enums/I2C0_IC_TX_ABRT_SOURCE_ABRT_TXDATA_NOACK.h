...
{
    VOID /*!< Transmitted data non-ACKed by addressed slave-scenario not
            present */
        ,
    GENERATED = 1 /*!< Transmitted data not ACKed by addressed slave */
};
...
inline const char *to_string(I2C0_IC_TX_ABRT_SOURCE_ABRT_TXDATA_NOACK instance)
{
    ...
    switch (instance)
    {
    case I2C0_IC_TX_ABRT_SOURCE_ABRT_TXDATA_NOACK::VOID:
        result = "VOID";
        break;
    case I2C0_IC_TX_ABRT_SOURCE_ABRT_TXDATA_NOACK::GENERATED:
        result = "GENERATED";
        break;
    }
                        ...
                        I2C0_IC_TX_ABRT_SOURCE_ABRT_TXDATA_NOACK &output)
{
    ...
    {
        output = I2C0_IC_TX_ABRT_SOURCE_ABRT_TXDATA_NOACK::VOID;
    }
    else if ((result = !strncmp(data, "GENERATED", 9)))
    {
        output = I2C0_IC_TX_ABRT_SOURCE_ABRT_TXDATA_NOACK::GENERATED;
    }
