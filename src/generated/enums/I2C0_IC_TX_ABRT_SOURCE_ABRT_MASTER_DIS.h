...
{
    VOID /*!< User initiating master operation when MASTER disabled- scenario
            not present */
        ,
    GENERATED = 1 /*!< User initiating master operation when MASTER disabled */
};
...
inline const char *to_string(I2C0_IC_TX_ABRT_SOURCE_ABRT_MASTER_DIS instance)
{
    ...
    switch (instance)
    {
    case I2C0_IC_TX_ABRT_SOURCE_ABRT_MASTER_DIS::VOID:
        result = "VOID";
        break;
    case I2C0_IC_TX_ABRT_SOURCE_ABRT_MASTER_DIS::GENERATED:
        result = "GENERATED";
        break;
    }
                        ...
                        I2C0_IC_TX_ABRT_SOURCE_ABRT_MASTER_DIS &output)
{
    ...
    {
        output = I2C0_IC_TX_ABRT_SOURCE_ABRT_MASTER_DIS::VOID;
    }
    else if ((result = !strncmp(data, "GENERATED", 9)))
    {
        output = I2C0_IC_TX_ABRT_SOURCE_ABRT_MASTER_DIS::GENERATED;
    }
