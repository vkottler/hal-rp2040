...
static constexpr uint16_t
    USBCTRL_DPRAM_EP7_IN_BUFFER_CONTROL_DOUBLE_BUFFER_ISO_OFFSET_id = 425;
    ...
    USBCTRL_DPRAM_EP7_IN_BUFFER_CONTROL_DOUBLE_BUFFER_ISO_OFFSET &output)
{
    ...
    {
        output =
            USBCTRL_DPRAM_EP7_IN_BUFFER_CONTROL_DOUBLE_BUFFER_ISO_OFFSET::128;
    }
    else if ((result = !strncmp(data, "256", 3)))
    {
        output =
            USBCTRL_DPRAM_EP7_IN_BUFFER_CONTROL_DOUBLE_BUFFER_ISO_OFFSET::256;
    }
    else if ((result = !strncmp(data, "512", 3)))
    {
        output =
            USBCTRL_DPRAM_EP7_IN_BUFFER_CONTROL_DOUBLE_BUFFER_ISO_OFFSET::512;
    }
    else if ((result = !strncmp(data, "1024", 4)))
    {
        output =
            USBCTRL_DPRAM_EP7_IN_BUFFER_CONTROL_DOUBLE_BUFFER_ISO_OFFSET::1024;
    }
